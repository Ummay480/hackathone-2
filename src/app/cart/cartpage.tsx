            ...
            return(
                <div key={i} className="flex  lg:w-[650px] p-4 rounded-[16px] border  justify-between">
                    ...
                    <div className="relative">
                         {/* btn */}
                      <button  onClick={()=>dispatch(removeFromCart(items.uuid))}><AiFillDelete className="text-red-500 cursor-pointer absolute right-2 top-0"/></button>
                     {/* INcreament decreament */}
                     <div className='flex justify-start items-center pt-10 '>
                     <button 
                     onClick={()=>dispatch(updateQuantity(items))}
